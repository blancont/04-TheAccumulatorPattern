...
def run_test_sum_more_cosines():
    ...
    ans = sum_more_cosines(1, 4)
    expect = -1.51948
    print('Test 2 expected:', expect, '(approximately)')
    print('       actual:  ', ans)

    ans = sum_more_cosines(2, 5)
    expect = -1.77612
...
def run_test_count_sines_from():
    ...
    # ------------------------------------------------------------------
    ans = count_sines_from(0, 2)
    expect = 1
    print('Test 2 expected:', expect)
    print('       actual:  ', ans)

    ans = count_sines_from(3, 5)
    expect = 3
    print('Test 3 expected:', expect)
    print('       actual:  ', ans)

    ans = count_sines_from(6, 9)
    expect = 2
    print('Test 4 expected:', expect)
    print('       actual:  ', ans)

    ans = count_sines_from(10, 11)
    expect = 2
    print('Test 5 expected:', expect)
    print('       actual:  ', ans)

    ans = count_sines_from(15, 18)
    expect = 3

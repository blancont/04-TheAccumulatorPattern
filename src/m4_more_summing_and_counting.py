...
def run_test_count_cosines_from():
    ...
    # ------------------------------------------------------------------
    expect = 1
    ans = count_cosines_from(3, 5, 0)
    print('Test 2 expected:', expect)
    print('       actual:  ', ans)

    expect = 1
    ans = count_cosines_from(6, 9, .8)
    print('Test 3 expected:', expect)
    print('       actual:  ', ans)

    expect = 4
    ans = count_cosines_from(4, 8, -.5)
    print('Test 4 expected:', expect)
    print('       actual:  ', ans)

    expect = 2
    ans = count_cosines_from(3, 9, 0.7)
    print('Test 5 expected:', expect)
    print('       actual:  ', ans)

    expect = 2
    ans = count_cosines_from(0, 3, 0)
...
def run_test_sum_unit_fractions_from():
    ...
    # ------------------------------------------------------------------
    ans = sum_unit_fractions_from(1, 3)
    expect = 11 / 6
    print('Test 2 expected:', expect, '(approximately)')
    print('       actual:  ', ans)

    ans = sum_unit_fractions_from(7, 12)
    expect = 18107 / 27720
    print('Test 3 expected:', expect, '(approximately)')
    print('       actual:  ', ans)
